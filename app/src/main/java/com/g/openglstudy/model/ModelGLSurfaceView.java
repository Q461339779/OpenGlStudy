...
public class ModelGLSurfaceView extends GLSurfaceView implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    private ModelMyGLRender mGLRender;
    ...
    public ModelGLSurfaceView(Context context, ModelMyGLRender glRender) {
        this(context, glRender, null);
    }

    public ModelGLSurfaceView(Context context, ModelMyGLRender glRender, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ModelMyGLRender getGLRender() {
        return mGLRender;
    }
